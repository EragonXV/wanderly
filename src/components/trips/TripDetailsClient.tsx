...
const MOCK_ITINERARY = [
    {
        ...
        items: [
            { id: '1', time: '10:00 AM', title: 'Arrive at KIX Airport', icon: <Map className="w-4 h-4" /> },
            { id: '2', time: '12:30 PM', title: 'Check in to Ryokan', icon: <MapPin className="w-4 h-4" /> },
            { id: '3', time: '02:00 PM', title: 'Lunch at Nishiki Market', icon: <Utensils className="w-4 h-4" /> }
        ]
    },
    {
        day: 2,
        ...
        items: [
            { id: '4', time: '08:00 AM', title: 'Fushimi Inari Shrine', icon: <Camera className="w-4 h-4" /> },
            { id: '5', time: '11:00 AM', title: 'Matcha Tasting', icon: <Coffee className="w-4 h-4" /> }
        ]
    }
];

export default function TripDetailsClient({ trip }: Props) {

...
export async function PATCH(req: Request, context: Context) {
    try {
        ...
        const budgetItem = await budgetItemClient.update({
            where: {
                id: itemId,
            },
            data: {
        ...
        return NextResponse.json(
            { message: 'Something went wrong while updating budget item' },
            { status: 500 }
        );
    }
}
...
export async function DELETE(_: Request, context: Context) {
    try {
        ...
        return NextResponse.json(
            { message: 'Something went wrong while deleting budget item' },
            { status: 500 }
        );
    }
}
